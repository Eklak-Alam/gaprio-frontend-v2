...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success('System access granted. Welcome to Gaprio.');
            router.push(response.data.nextStep || '/onboarding/profile');
        } catch (error) {
    ...
    return (
        // Removed pt-20, so it naturally centers vertically using flex
                ...
                <div className="w-full max-w-[380px]"> 
                    ...
                    <div className="mb-10 gsap-form-item">
                        ...
                        <p className="text-zinc-400 text-sm">
                            Connect your tools and deploy the Gaprio AI Core in seconds.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5"> 
                        <div className="grid grid-cols-2 gap-4">
                            <div className="gsap-form-item">
                                <label className="block text-xs font-medium text-zinc-400 mb-1.5 uppercase tracking-wide">First Name</label>
                                <input
                                    type="text"
                                    name="firstName"
                                    placeholder="Jane"
                            ...
                            <div className="gsap-form-item">
                                <label className="block text-xs font-medium text-zinc-400 mb-1.5 uppercase tracking-wide">Last Name</label>
                                <input
                                    type="text"
                                    name="lastName"
                                    placeholder="Doe"
                        ...
                        <div className="gsap-form-item">
                            <label className="block text-xs font-medium text-zinc-400 mb-1.5 uppercase tracking-wide">Security Key</label>
                            <input
                                type="password"
                                name="password"
                                placeholder="••••••••••••"
                ...
                <div className="relative z-10 max-w-xl">
                    ...
                    <div className="mb-12">
                        ...
                        <h2 className="gsap-visual-text text-3xl xl:text-4xl font-semibold text-white leading-tight mb-4 tracking-tight">
                            The AI Brain for Your Enterprise.
                        </h2>
                    ...
                    {/* The "Agentic AI Core" Terminal UI */}
                    <div className="gsap-terminal-window bg-[#050505] border border-white/10 rounded-xl overflow-hidden shadow-2xl font-mono text-xs sm:text-sm">
                        ...
                        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-white/[0.02]">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-zinc-500">Gaprio Agent Core v1.4</span>
                            </div>
                        ...
                        <div className="p-5 space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[#FC8B32] font-semibold">Signal Detected: Client • Slack</span>
                            </div>
                            
                            <div className="pl-5 border-l border-white/10">
                                <p className="text-zinc-300 italic mb-2">
                                    "We need the updated contract for the Q4 project by EOD today."
                                </p>
                            </div>

                            <div className="space-y-1.5 text-zinc-500 pt-2">
                                <p className="gsap-terminal-line flex gap-2">
                                    <span className="text-zinc-600">&gt;</span> 
                                    Analyzing intent, sentiment, and urgency instantly...
                                </p>
                                <p className="gsap-terminal-line flex gap-2">
                                    <span className="text-zinc-600">&gt;</span> 
                                    Building memory graph: Google Drive, Jira history.
                                </p>
                                <p className="gsap-terminal-line flex gap-2 text-zinc-300">
                                    <span className="text-[#FC8B32]">&gt;</span> 
                                    Action formulated. Awaiting human approval.
                                </p>
                            </div>
                        </div>
                    </div>
