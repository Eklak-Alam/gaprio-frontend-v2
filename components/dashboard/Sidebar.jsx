...
// export function fireComingSoon(label) {
//     toast.custom(
//         (t) => (
//             <motion.div
...
//                     shadow-[0_16px_48px_rgba(0,0,0,0.7),0_0_0_1px_rgba(255,255,255,0.03)]
//                     w-[300px] sm:w-[320px]"
//             >
//                 {/* Icon bubble */}
//                 <div className="relative w-10 h-10 rounded-xl shrink-0
//                     bg-gradient-to-br from-[#F3842A]/20 to-[#F3842A]/5
//                     border border-[#F3842A]/20
//                     flex items-center justify-center">
//                     <Wrench size={15} className="text-[#F3842A]" />
//                     <span className="absolute -top-1 -right-1 w-3.5 h-3.5
//                         bg-[#111] rounded-full border border-white/[0.08]
//                         flex items-center justify-center">
//                         <Clock size={8} className="text-[#F3842A]/60" />
//                     </span>
//                 </div>
...
//                             {label}
//                         </p>
//                         <span className="shrink-0 text-[8px] font-bold text-[#F3842A]
//                             bg-[#F3842A]/10 border border-[#F3842A]/20
//                             px-1.5 py-0.5 rounded-md uppercase tracking-wider">
//                             Soon
//                         </span>
//                     </div>
//                     <p className="text-[11px] text-zinc-500 leading-snug">
//                         We're actively building this integration.
//                     </p>
//                 </div>
...
//         ),
//         {
//             id: `coming-soon-${label}`,   // deduplicates — same label won't stack
//             duration: 3500,
