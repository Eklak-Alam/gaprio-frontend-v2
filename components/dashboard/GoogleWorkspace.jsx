...
// ── brand colour token ───────────────────────────────────────
// Use this CSS custom-property everywhere instead of hard-coded orange
// We also reference it via Tailwind JIT arbitrary values: [#F3842A]
...
export default function GoogleWorkspace({ isConnected, data, user, onRefresh }) {
    ...
    const handleDisconnect = async () => {
        ...
        try {
            await api.delete('/integrations/disconnect/google');
